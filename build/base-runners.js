...
var check = function check(analysis, eventData) {
  var _eventData$data, _eventData$data$chang, _eventData$data$chang2;
  ...
  eventData.baserunnerCount) {
    ...
    return true;
  } else if (eventData !== null && eventData !== void 0 && (_eventData$data = eventData.data) !== null && _eventData$data !== void 0 && (_eventData$data$chang = _eventData$data.changedState) !== null && _eventData$data$chang !== void 0 && (_eventData$data$chang2 = _eventData$data$chang.baserunners) !== null && _eventData$data$chang2 !== void 0 && _eventData$data$chang2.length) {
    var _iterator = _createForOfIteratorHelper(eventData.data.changedState.baserunners),
        _step;
